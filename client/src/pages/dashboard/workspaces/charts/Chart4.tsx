...
export function Chart4({ taskData }: { taskData: TaskData[] }) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="sticky">Project's Task Distribution</CardTitle>
        <CardDescription>On the Basis of Kanban View</CardDescription>
      </CardHeader>
      <CardContent>
        <ScrollArea className="rounded-lg w-full whitespace-nowrap shrink-0">
          <ChartContainer config={chartConfig} className="h-[375px] w-full">
            <BarChart accessibilityLayer data={taskData} margin={{ top: 20, bottom: 20 }}>
